        ...
        <form class="mt-6 space-y-6" method="POST" action="{{ route('admin.user.update', $user) }}" enctype="multipart/form-data">
            ...
            <div class="grid gap-4 md:grid-cols-2">
                ...
                <div class="space-y-1">
                    ...
                    <input id="nim" name="nim" value="{{ old('nim', $user->nim) }}" class="w-full rounded-2xl border border-slate-200 bg-white px-4 py-3 text-sm text-slate-900 shadow-soft outline-none ring-emerald-200 transition focus:border-emerald-300 focus:ring-4" placeholder="NPM untuk Mahasiswa / NUPTK untuk Dosen">
